...
$dbconnect = mysqli_connect('localhost', 'root', '','kulsom');
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/animate.css">
    ...
    <link rel="shortcut icon" type="imgse/ x-con" href="img/work1.jpg"> 
...
<p>
    If you want any website, development & fackebook page boost, After that you can contact me.</p>

<div class="social-icon ">
     <ul> 
 <li><a href="https://www.facebook.com/profile.php?id=100007120715015"><i class="fab fa-facebook-f"></i></a></li>
 
 <li><a href="https://mail.google.com/mail/u/1/#inbox"><i class="fab fa-google-plus-g"></i></a></li>

 <li><a href="https://www.linkedin.com/in/kamrul-hassan-1a996b1a6/"> <i class="fab fa-linkedin-in"></i></a></li>
        </ul>
</div>
...
Web Design</div>
<p>
I Develop Dynamic Responsive Website, E-Commerce Stores, Different Kinds Of Web Portal And Other Web Application Admin Panel.
</p>
</div>
</div>
<div class="card">
...
Facebook Marketing ( Social Engineering )
Email Marketing ( Using our own database of leads)
SMS marketing</div>
</div>
</div>
</div>
...
<div class="skills-content">
                <div class="column left">
                        ...
                        <h2 class="text wow lightSpeedIn" data-wow-duration="3s">My creative skills & experiences</h2>


<p>I am  Web Design & Developer  For Your It Care. I am  Very Friendly And More Talented Member Are Working Toward. In This Company Every Member Are Successful In Their Academic Life And Processional Career. And All The Member Are Fresher But All Of Us Are More Skillful Then Other. Here I Can Find More Complexity.</p>
<a href="#">Read more</a>
                </div>
<div class="column right">
                    <div class="bars">
...
<div class="container">
    <div class="row">
        <div class="col-md-4 img-hov" class="img-fluid">
            <img src="img/project1.PNG" class="img-fluid">
<span>
    <h1>Infinity Job</h1>
    <a href="#">Infinity Job</a>
</span>
            
        </div>
        <div class="col-md-4 img-hov">
            <img src="img/project2.PNG" class="img-fluid">
<span>
    <h1>Pichtech Limited</h1>
    <a href="#">www.pichtech.com</a>
</span>
        </div>
        <div class="col-md-4 img-hov">
            <img src="img/project3.PNG" class="img-fluid">
            <span>
                <h1>Jobshare</h1>
                <a href="#">Jobshare</a>
            </span>
